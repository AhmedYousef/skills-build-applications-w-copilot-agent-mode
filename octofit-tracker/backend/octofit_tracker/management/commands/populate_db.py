...
# Sample models for demonstration (should be replaced with actual models in a real app)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        activities = [
            ...
            Activity(user='Superman', type='Yoga', duration=40),
        ]
        ...
        # Create workouts
        workouts = [
            Workout(name='Morning Cardio', difficulty='Medium'),
